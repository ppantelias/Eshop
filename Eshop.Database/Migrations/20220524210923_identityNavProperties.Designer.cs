...
namespace Eshop.Database.Migrations
{
    ...
    [Migration("20220524210923_identityNavProperties")]
    partial class identityNavProperties
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Eshop.Domain.Models.Identity.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d1a7e104-641f-40a0-824d-9e4fd643a07c"),
                            ConcurrencyStamp = "7e521a3c-9764-4417-aef9-9b46544acc0d",
                            Name = "System",
                            UserRole = 0
                        },
                        new
                        {
                            Id = new Guid("3fac61bc-7476-44b6-88e5-25cad8362a62"),
                            ConcurrencyStamp = "b1a2b1d4-b9e2-4f64-b39a-ecd8e1ee0477",
                            Name = "FullAdmin",
                            UserRole = 1
                        },
                        new
                        {
                            Id = new Guid("2ab07f0a-ff34-467d-9bb6-f374ea1b8e60"),
                            ConcurrencyStamp = "03a5141e-f813-4b8f-a9d0-eeea05d1f786",
                            Name = "ShopAdmin",
                            UserRole = 2
                        },
                        new
                        {
                            Id = new Guid("7791bc6c-1242-49b1-a644-99052ecf730c"),
                            ConcurrencyStamp = "7b6574ff-82c8-4449-ae39-676fbefe554e",
                            Name = "StorageAdmin",
                            UserRole = 3
                        },
                        new
                        {
                            Id = new Guid("4442cc9f-7054-443a-89a3-be702ab9ed14"),
                            ConcurrencyStamp = "34bfba84-7fa0-4127-b459-9e65ebcb60ad",
                            Name = "UserAdmin",
                            UserRole = 4
                        },
                        new
                        {
                            Id = new Guid("fdcd4255-14e9-4522-9df1-24e1ddb577d1"),
                            ConcurrencyStamp = "69906d89-acff-418c-957d-7432a4b66bc6",
                            Name = "Customer",
                            UserRole = 5
                        });
                });
            ...
            modelBuilder.Entity("Eshop.Domain.Models.Identity.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("14b68c5c-b990-4038-857a-b70a65ced3dd"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "e85927f5-97d7-4b69-a0c3-375ce5211253",
                            Email = "fullAdmin@eshop.com",
                            EmailConfirmed = false,
                            Firstname = "FullAdmin",
                            Lastname = "FullAdmin",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAEIpJbDjFE6e7f01IM29NSwvPpiXptfAGDaRBzX+ZF1L3+LRP+IIvCxDxIc5WBoffvg==",
            ...
            modelBuilder.Entity("Eshop.Domain.Models.Identity.ApplicationUserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("14b68c5c-b990-4038-857a-b70a65ced3dd"),
                            RoleId = new Guid("3fac61bc-7476-44b6-88e5-25cad8362a62")
                        });
                });
            ...
            modelBuilder.Entity("Eshop.Domain.Models.Identity.ApplicationRoleClaim", b =>
                {
                    b.HasOne("Eshop.Domain.Models.Identity.ApplicationRole", "Role")
                        .WithMany("RoleClaims")
            ...
            modelBuilder.Entity("Eshop.Domain.Models.Identity.ApplicationUserClaim", b =>
                {
                    b.HasOne("Eshop.Domain.Models.Identity.ApplicationUser", "User")
                        .WithMany("Claims")
